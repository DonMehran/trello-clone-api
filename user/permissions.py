...
class IsProfileOwnerOrReadOnly(permissions.BasePermission):
    '''
    CUSTOM PERMISSION FOR PROFILE CLASS TO ALLOW ONLY GET AND POST REQUESTS OR PUT AND PATCH IF OWNER
    '''
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if not request.user.is_anonymous and request.user.profilemodel == obj:
            return True
